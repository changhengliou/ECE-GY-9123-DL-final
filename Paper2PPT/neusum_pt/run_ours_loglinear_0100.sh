...
# -significant_criteria threshold -significant_value 10 \
# -significant_criteria magnitude -significant_value 5 \
...
python3 train.py -save_path $SAVEPATH \
                 ...
                 -enable_log_linear -loglinear_learning_rate 0.01 -position_weight 0 -keyword_weight 1 -in_bert_weight 0 -in_section_weight 0 -qtype $QTYPE
