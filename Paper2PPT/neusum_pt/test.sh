...
# log-linear model (haven't use / decode hasn't involve log-linear model)
# -test_bert_annotation $DATAHOME/test/$QTYPE/test.txt.bert \
# -position_weight -1 -keyword_weight 1 -in_bert_weight 1 -qtype $QTYPE \
...
python3 test.py -save_path $SAVEPATH \
                ...
                -batch_size 64 -beam_size 10 -n_best_size 1 -output_len 1 \
