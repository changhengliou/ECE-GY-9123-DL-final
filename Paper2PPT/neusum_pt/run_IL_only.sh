...
QTYPE=${1:-"."}
MODELNAME=${2:-"IL_only"} # i.e. without co-teaching
...
python3 train.py -save_path $SAVEPATH \
                 ...
                 -batch_size 32 -beam_size 10 -n_best_size 1 -output_len 5 \
                 -gpus 0 \
                 -epochs 20 \
                 ...
                 -relabel_epoch 9 -start_train_with_em -1 \
                 -stop_em_and_loglinear_after -1 \
                 -use_good_data_only_before -1 -add_all_bad_data_after 0 \
