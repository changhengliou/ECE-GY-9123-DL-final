...
# To see if "co-training" can be replaced "self-training" in 15-20 epochs for better/steady results
...
QTYPE=${1:-"."}
MODELNAME=${2:-"SelfLearning_TS0-10_EM10-15_SL15-20_Add15-20"}
...
# TODO: better rename stop_em_and_loglinear_after to stop_train_with_em_before
...
python3 train.py -save_path $SAVEPATH \
                 ...
                 -relabel_epoch 99 -start_train_with_em 10 \
                 -stop_em_and_loglinear_after 15 \
                 -use_good_data_only_before 15 -add_all_bad_data_after 20 \
