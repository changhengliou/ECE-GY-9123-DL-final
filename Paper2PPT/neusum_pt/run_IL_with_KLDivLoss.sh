...
QTYPE=${1:-"."}
MODELNAME=${2:-"IL_with_KLDivLoss"} # this has memory issue
...
# This -IL_with_KLDivLoss will consume lots of memory during EM stage
...
python3 train.py -save_path $SAVEPATH \
                 ...
                 -batch_size 4 -beam_size 10 -n_best_size 1 -output_len 5 \
                 -gpus 0 \
                 -epochs 20 \
