...
python3 train.py -save_path $SAVEPATH \
                 ...
                 -batch_size 16 -beam_size 10 -n_best_size 1 -output_len 5 \
                 -gpus 0 \
                 -epochs 15 \
                 ...
                 -relabel_epoch 99 -start_train_with_em 1 \
                 -stop_em_and_loglinear_after 99 \
                 -use_good_data_only_before 15 -add_all_bad_data_after 99 \
                 -significant_criteria threshold -significant_value 1 \
                 -start_update_good_data_set 1 -early_stop_change_percent 0.01 \
                 -enable_log_linear -position_weight 0 -keyword_weight 1 -in_bert_weight 1 -in_section_weight 1 -qtype $QTYPE |& tee log_${QTYPE}.txt
