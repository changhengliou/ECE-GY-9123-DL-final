...
VERBOSE = True # if not VERBOSE, then it is always override mode
if not VERBOSE:
...
if __name__ == "__main__":
    ...
    for topic in DATA_TO_TEST.keys():
        ...
        for summ in summaries:
            ...
            avg_word_num += summ.word_num

        print topic
        print 'Maximum word count of this topic is', max_word_num
        print 'Average word count of this topic is', avg_word_num / len(summaries)
